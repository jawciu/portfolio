          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <a
                ...
                className="ml-1 inline-flex items-center gap-1.5 font-[family-name:var(--font-mono)] text-[13px] text-[var(--case-study-muted)] underline decoration-[var(--case-study-line)] underline-offset-4 transition-colors hover:text-[var(--case-study-accent)]"
              >
                <LinkIcon />
                vector.quest
              </a>
