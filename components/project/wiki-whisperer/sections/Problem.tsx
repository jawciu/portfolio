...
const LINES = [
  "Energy specialists - support call centre agents at E.ON Next - need to be able to handleany query across hundreds of processes, protocols and tools that never stop changing.",
  "Recalling the right answer with a customer on the line is genuinely hard, so the cognitive load is constant. The earlier tools did not solve it. Keyword search into documents was inacurate, and Wiki Whisperer V1, the first AI attempt, launched to excitement then lost trust. It returned too many dead ends and forced specialists to phrase prompts in exactly the right way.",
