...
*(Built as a horizontal timeline, 2026-07-13: five stops on one lilac→peach rail. Stops 1–4 are the signals; the fifth stop is the human fallback.)*

**TIMELINE STOP — signal #01 >** attendee domains
Every meeting arrives with its invite list. An attendee's email domain matching a customer's is the strongest signal.

**TIMELINE STOP — signal #02 >** contact emails
Failing that, each attendee's email is looked up against every onboarding's contacts. Slower, but precise.

**TIMELINE STOP — signal #03 >** the title
...
**TIMELINE STOP — signal #04 >** the transcript
...
**TIMELINE STOP — no signal >** needs your input
